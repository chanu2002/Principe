...
<html>
<head>
    <title>Edit Admin | Principe Grand</title>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="form-card">
        ...
        <form action="<%=request.getContextPath()%>/AdminServlet"
            ...
            <input type="text" name="password" value="<%=admin.getPassword()%>" required>

            <label>Name</label>
            <input type="text" name="name" value="<%=admin.getName()%>" required>

            <label>Role</label>
            <input type="text" name="role" value="<%=admin.getRole()%>" required>

            <label>Current Image</label>
            <img src="<%=request.getContextPath()%>/AdminImageServlet?id=<%=admin.getAdminId()%>" width="100" height="100">
